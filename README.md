...
3. Install clojure-mcp-light (run both commands):
   ...
   From GitHub:
   ```bash
   bbin install https://github.com/bhauman/clojure-mcp-light.git --tag v0.0.1-alpha
   ```
   ```bash
   bbin install https://github.com/bhauman/clojure-mcp-light.git --tag v0.0.1-alpha --as clj-nrepl-eval --main-opts '["-m"  "clojure-mcp-light.nrepl-eval"]'
   ```
